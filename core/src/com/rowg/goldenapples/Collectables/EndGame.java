...
public class EndGame  {
    ...
    public EndGame (PlayScreen screen, Rectangle bounds, GameMain gameMain)
    {
        ...
        fixtureDef.filter.categoryBits = GameMain.WIN_GAME_BIT;
    ...
    public void winGameCollision()
    {
        if (HUD.checkVanat() == 1)
        {
            this.gameMain.setScreen(new WinScreen(this.gameMain));
            HUD.resetAll();
